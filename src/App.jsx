...
const STYLE = `
  .gsc { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; background:#F3EFE0; color:#2B2B28; min-height:100vh; -webkit-tap-highlight-color: transparent; overflow-x:hidden; }
        ...
        <Header
          ...
          right={
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 6, alignSelf: "flex-start" }}>
              <div className="gsc-code" style={{ width: 100, textAlign: "center" }}>{round.id}</div>
