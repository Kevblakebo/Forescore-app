          ...
          {authLoading ? (
            ...
            <div className="gsc-card" style={{ textAlign: "center", padding: "28px 20px" }}>
              ...
              <div style={{ fontSize: 13, color: "#6b6b63", lineHeight: 1.5, marginBottom: 16 }}>
                Log in to save your defaults (name, handicap, Venmo, home course) and unlock stats and prior saved rounds. Logging in is always optional - you can keep playing instantly with just a round or tournament code, exactly like today.
              </div>
