      ...
      <div className="gsc">
        ...
        <div className="gsc-body gsc-body-tabbed">
          <div style={{ fontSize: 13, color: "#4b4b45", lineHeight: 1.55, margin: "0 0 16px" }}>
            No more redoing the math or arguing about the rules. Foresa makes it easy and fun to play various golf game formats, share your scores live on the course, and settle who's buying at the 19th hole!
            <br />
            <br />
